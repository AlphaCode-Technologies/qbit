...
import { Calendar, CalendarBody, CalendarEvent, CalendarHeader } from '@inputs/chrono';
...
const App = () => {
  ...
  const sampleEvents = [
    ...
    { date: new Date(new Date().getFullYear(), new Date().getMonth() - 1, 20, 9, 30), value: 'Client Call' },
  ...
  return (
    <div data-id="my-id">
      ...
      <div className="mt-4 max-w-4xl mx-auto">
        <Calendar renderers={{ renderer: CalendarSkin }} keyExtractor={(value: string, i: number) => `${value}-${i}`}>
          ...
          >
            <CalendarEvent renderers={{ renderer: CalendarEventSkin }} events={sampleEvents} />
          </CalendarBody>
        </Calendar>
      </div>
      <br />
