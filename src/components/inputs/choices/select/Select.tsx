...
const Select = ({ children, ...rest }: com.elem.Shell<AlphaElements.OptionProperties, AlphaElements.SelectActions>) => {
  ...
  const { disabled, optionContainerClassName = 'rounded p-4 bg-slate-100 mt-1 min-h-64 max-h-72' } = properties;
  ...
  return (
    <div ref={ref} className="w-fit">
      <div onClick={() => !disabled && setIsOpen(true)}>
        <Shell<AlphaElements.OptionProperties, AlphaElements.SelectActions>
