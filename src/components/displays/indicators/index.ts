...
export { Rating } from './ratings';
export { default as Snippet } from './snippets/Snippet';
...
export { type RatingProps } from './ratings';
export { type SnippetProps } from './snippets/properties';
